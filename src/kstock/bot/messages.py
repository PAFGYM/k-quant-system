...
def format_help() -> str:
    return (
        f"\u2753 {USER_NAME}, K-Quant 봇 사용법\n"
        + "\u2500" * 25 + "\n\n"
        "\U0001f514 실시간 알림\n"
        "  최근 발송된 매수/매도 알림을 확인합니다.\n\n"
        "\U0001f4ca 오늘의 추천종목\n"
        "  종목 스코어링 + 전략 태그 + ML 예측.\n\n"
        "\U0001f30d 시장현황\n"
        "  S&P, VIX, 환율, BTC, 금 + 정책 이벤트.\n\n"
        "\U0001f4bc 내 포트폴리오\n"
        "  보유 종목 수익률 추적 + 상관관계 경고.\n\n"
        "\U0001f4f8 계좌분석\n"
        "  스크린샷 보내면 AI가 자동 분석 + 종목 진단.\n\n"
        "\U0001f4c8 추천 성과\n"
        "  추천 성과 현황 + 전략별 승률.\n\n"
        "\U0001f3af 전략별 보기\n"
        "  7가지 전략별 추천 확인.\n\n"
        "\U0001f4e1 KIS 설정\n"
        "  /setup_kis - KIS API 연동 설정.\n\n"
        "\u2699\ufe0f 최적화\n"
        "  /optimize [종목코드] - 파라미터 최적화\n\n"
        "\U0001f4ca 백테스트\n"
        "  /backtest [종목코드] - 백테스트 실행\n\n"
        + "\u2500" * 25 + "\n"
        "\U0001f4cc 알림은 자동으로 옵니다!\n"
        "  \U0001f7e2 매수 조건 시 -> 매수 알림\n"
        "  \U0001f7e1 조건 근접 시 -> 관심 알림\n"
        "  \U0001f534 익절/손절 시 -> 매도 알림\n"
        "  \U0001f680 골든크로스 시 -> 모멘텀 알림\n"
        "  \U0001f4a5 신고가 돌파 시 -> 돌파 알림\n"
        "  \U0001f916 ML 예측 (매일 08:30)\n"
        "  \U0001f4f0 뉴스 감성 (매일 08:00)\n\n"
        "K-Quant System v3.0"
    )
