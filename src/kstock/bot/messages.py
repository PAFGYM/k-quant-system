...
MENU_TIPS: dict[str, str] = {
    "analysis": "💡 종목명이나 6자리 코드를 보내면 바로 분석 버튼이 뜹니다",
    "market": "💡 오늘 장세와 공격/방어 전략을 먼저 확인하세요",
    "balance": "💡 보유종목별 전담 매니저가 유지/축소/교체 의견을 드립니다",
    "favorites": "💡 카테고리 탭으로 75종목을 한눈에 관리하세요",
    "ai_chat": "💡 종목 의견, 매수 타이밍, 시장 해석을 바로 질문하세요",
